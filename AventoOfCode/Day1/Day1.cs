            ...
            for (int x = 0; x < input.Length; x++)
            {
                for (int y = 1; y < input.Length; y++)
                {
                    for (int z = 2; z < input.Length; z++)
                    {
                        ...
                        {
                            Console.WriteLine(input[x] + " " + input[y] + " " + input[z]);
                            Console.WriteLine(input[x] * input[y] * input[z]);
                            break;
                        }
                    }
